          ...
          return (
            <button
              ...
              className={cn(
                ...
                isActive ? 'border-transparent shadow-sm' : 'border-transparent text-ink-muted hover:text-ink hover:bg-canvas-soft',
              )}
              style={isActive ? { backgroundColor: `${metric.color}10`, color: metric.color, borderColor: `${metric.color}30` } : undefined}
            >
              <span className='w-2 h-2 rounded-full shrink-0' style={{ backgroundColor: isActive ? metric.color : '#a39e98' }} />
              {metric.label}
            </button>
          );
        })}
      ...
      <div className='px-2 pb-4'>
        <ResponsiveContainer width='100%' height={300}>
          ...
          >
            ...
            />
            <Legend verticalAlign='top' align='right' height={0} wrapperStyle={{ display: 'none' }} />
